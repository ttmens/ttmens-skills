...
**Platforms:** Cursor · Hermes · OpenCode · **Pipeline:** `pm-idea-to-mvp` v9.1.0

**文档索引：** [ARCHITECTURE](docs/ARCHITECTURE.md) · [CODING_CONVENTIONS](docs/CODING_CONVENTIONS.md) · [DEPLOY_CONVENTIONS](docs/DEPLOY_CONVENTIONS.md) · [HERMES_ARCHITECTURE](docs/HERMES_ARCHITECTURE.md)

---

## 设计思想（读这一节就懂「为什么这样建」）

### 1. 产物优先（Artifact-first, v9.1）

阶段完成由 **SKILL.md 产物路径**证明。核心脚本：`init-project.py`、`inner-loop-driver.py`、`consume-feedback.py`。
...
37 个 core skill → v9.1 为 **38**（含 `remote-server-deployment`）：
...
| 技能 | Stage | 能力 |
|------|-------|------|
| **pm-idea-to-mvp** | all | 唯一主流水线 v9.1 |
...
python scripts/validate_skills.py       # marketplace + layout + v9.1 脚本
